...
const logoAssetPath = join(extensionRoot, "assets", "cicero-goals-mark.png");
...
export function normalizeGoalBoard(document, goalDir = "<memory>") {
  ...
  if (Number(document.version) !== 2) {
    throw new GoalBoardError("Only Cicero Goals v2 state.yaml files are supported.");
  }
...
export function writeBoardApp(goalDir) {
  const appDir = join(resolve(goalDir), ".cicero-goals-board");
  ...
  copyFileSync(logoAssetPath, join(appDir, "cicero-goals-mark.png"));
  return appDir;
}
...
<head>
  ...
  <title>Cicero Goals Board</title>
  <link rel="stylesheet" href="./styles.css">
</head>
<body>
  <header class="topbar">
    <div class="topbar-primary">
      <div class="brand" aria-label="Cicero Goals">
        <img class="brand-mark" src="./cicero-goals-mark.png" alt="Cicero Goals">
        <span class="brand-name">Cicero Goals</span>
        <span class="live-dot" id="live-dot" aria-hidden="true"></span>
      </div>
      <nav class="board-switcher is-empty" aria-label="Local Cicero Goals boards">
        <label for="board-switcher">Board</label>
        <select id="board-switcher" aria-label="Switch local board"></select>
      </nav>
    </div>
    <div class="header-tools">
      <a class="github-stars" href="https://github.com/amacdonald-cgs/cicero-goals" target="_blank" rel="noreferrer" aria-label="Open Cicero Goals on GitHub">
  ...
  <main class="shell">
    <section class="goal-header" aria-labelledby="goal-title">
      <div>
        ...
        <h1 id="goal-title">Cicero Goals Board</h1>
...
const settingsStorageKey = "cicero-goals.localBoardSettings.v1";
...
function renderBoard(board) {
  ...
  document.title = board.goal.title ? board.goal.title + " - Cicero Goals Board" : "Cicero Goals Board";
...
function renderBoardError(message) {
  ...
  node.append(
    el("h2", "", "Cicero Goals could not parse this board"),
    el("p", "", message),
  );
  return node;
}
...
function boardOptionLabel(board) {
  const title = board.title || board.slug || board.goalDir || "Cicero Goals board";
