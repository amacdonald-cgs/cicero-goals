...
This extension is local-first. It helps a Cicero Goals run turn repo files, commands, conventions, and recent receipts into an onboarding artifact for developers or future agents. It does not edit project docs by default.
