...
This extension is local-first. It helps a Cicero Goals run assemble release evidence from changed files, package metadata, verification commands, docs, examples, and follow-up risks. It does not publish a release or change versions by default.
