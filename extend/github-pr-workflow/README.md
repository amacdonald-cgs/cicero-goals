...
Prepare receipt-aligned commit boundaries and GitHub pull request handoff text from a Cicero Goals board without making GitHub the source of truth.
...
- A Cicero Goals run is ready for a pull request.
...
- Summary
- Goal context
- Commit plan mapped to Cicero Goals receipts
- Changed files
- Verification
- Review notes
