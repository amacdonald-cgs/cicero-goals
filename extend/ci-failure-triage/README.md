...
This extension is local-first. It helps a Cicero Goals run summarize failed commands, CI logs, recent Worker receipts, and changed files into likely causes and next steps. It does not connect to a CI provider by default.
