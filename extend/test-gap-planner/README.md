...
Turn a changed diff and Cicero Goals receipts into a focused test plan.

This extension is local-first. It helps a Cicero Goals run identify behavior that changed, tests that already ran, edge cases that remain weakly covered, and the smallest next tests worth adding. It does not write tests automatically.
