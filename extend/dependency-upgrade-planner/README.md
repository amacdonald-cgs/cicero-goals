...
This extension is local-first. It helps a Cicero Goals run evaluate candidate dependency upgrades, runtime policy, migration notes, verification commands, and rollback options. It does not edit dependency files or contact a package registry by default.
